      ...
      <div className="container flex py-12 lg:py-24 flex-col justify-between gap-8 md:gap-14 lg:flex-row lg:gap-20">
        ...
        <div className="flex-1 text-lg font-medium">
          ...
          <div className="max-w-xl space-y-6">
            ...
            <p className="text-muted-foreground">Um die Wettbewerbsfähigkeit des deutschen KI-Standorts zu stärken, wurde die Initiative MISSION KI als Hebelprojekt der Digitalstrategie der Bundesregierung ins Leben gerufen. MISSION KI wurde vom Bundesministerium für Digitales und Staatsmodernisierung finanziert und von acatech – Deutsche Akademie der Technikwissenschaften von Mai 2023 bis Dezember 2025 umgesetzt. Im Rahmen der Initiative hat MISSION KI gemeinsam mit führenden Akteuren aus Wirtschaft, Wissenschaft, Normung und Prüfwesen einen Qualitätsstandard entwickelt, der KI-Qualität systematisch messbar und nachweisbar macht.</p>
            <p className="text-muted-foreground">Das Verfahren ermöglicht Organisationen, Qualitätsversprechen strukturiert zu belegen – für schnellere Vertrauensbildung bei Kunden und Investoren, effizientere Beschaffung und gezielte Vorbereitung auf regulatorische Anforderungen wie den EU AI Act.</p>
            <p className="text-muted-foreground text-xs">©acatech – Deutsche Akademie der Technik&shy;wissenschaften e. V.<br />Der Standard ist lizensiert unter <a className="underline" href="https://creativecommons.org/licenses/by/4.0/deed.de" target="_blank">CC BY 4.0</a></p>
