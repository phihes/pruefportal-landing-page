      ...
      <div className="container flex py-12 lg:py-24 flex-col justify-between gap-8 md:gap-14 lg:flex-row lg:gap-20">
        ...
        <div className="flex-1 text-lg font-medium">
          ...
          <div className="max-w-xl space-y-6">
            ...
            <p className="text-muted-foreground text-xs">©acatech – Deutsche Akademie der Technik&shy;wissenschaften e. V.<br />Der Standard ist lizenziert unter <a className="underline" href="https://creativecommons.org/licenses/by/4.0/deed.de" target="_blank">CC BY 4.0</a></p>
