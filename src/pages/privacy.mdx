...
Wir erheben als Betreiber dieser Website selbst keine Daten. Einige Ihrer Daten werden beim Besuch der Website durch die IT-Systeme unseres Hosters erfasst (siehe unten). Das sind vor allem technische Daten (z. B. Internetbrowser, Betriebssystem oder Uhrzeit des Seitenaufrufs). Die Erfassung dieser Daten erfolgt automatisch, sobald Sie diese Website betreten.
